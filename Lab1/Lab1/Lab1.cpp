...
void                DoWork1(HINSTANCE, HWND);
void                DoWork2(HINSTANCE, HWND);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(
       szWindowClass,
       L"Lab #1 - Yevgen Yakovliev IP-05",
       WS_OVERLAPPEDWINDOW,
       CW_USEDEFAULT,
       0,
       CW_USEDEFAULT,
    ...
    case WM_PAINT:
        {
            ...
            TextOutW(hdc, 10, 10, firstWorkBuf, 255);
...
void DoWork1(HINSTANCE hInst, HWND hWnd) {
    Func_MOD1(hInst, hWnd, firstWorkBuf);
